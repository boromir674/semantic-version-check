...
# builds the documentation pages of the semantic-version-checker
# project.
...
def get_templated_vars():
    return type(
        ...
        (),
        dict(
            project_slug='semantic-version-check',
            package_name='semantic_version_check',
            author_name='Konstantinos Lampridis',
            year='2022',
            version='0.0.1',
            github_username='boromir674',
            repo_name='semantic-version-check',
        ),
    )
